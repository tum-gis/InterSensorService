...
import org.tum.gis.minisos.interfaces.sensorThingsApi.datastreams.Datastream;
import org.tum.gis.minisos.interfaces.sensorThingsApi.datastreams.Datastreams;
import org.tum.gis.minisos.interfaces.sensorThingsApi.datastreams.UnitOfMeasurement;
import org.tum.gis.minisos.interfaces.sensorThingsApi.featuresOfInterest.FeatureOfInterest;
import org.tum.gis.minisos.interfaces.sensorThingsApi.featuresOfInterest.FeaturesOfInterest;
import org.tum.gis.minisos.interfaces.sensorThingsApi.historicalLocations.HistoricalLocation;
import org.tum.gis.minisos.interfaces.sensorThingsApi.historicalLocations.HistoricalLocations;
...
import org.tum.gis.minisos.interfaces.sensorThingsApi.locations.Locations;
import org.tum.gis.minisos.interfaces.sensorThingsApi.observations.Observation;
import org.tum.gis.minisos.interfaces.sensorThingsApi.observations.Observations;
import org.tum.gis.minisos.interfaces.sensorThingsApi.observedProperties.ObservedProperties;
import org.tum.gis.minisos.interfaces.sensorThingsApi.observedProperties.ObservedProperty;
import org.tum.gis.minisos.interfaces.sensorThingsApi.sensors.Sensor;
import org.tum.gis.minisos.interfaces.sensorThingsApi.sensors.Sensors;
import org.tum.gis.minisos.interfaces.sensorThingsApi.things.Thing;
import org.tum.gis.minisos.interfaces.sensorThingsApi.things.Things;
...
public class SensorThingsApiService {
	...
	public Observations getObservations() throws ParseException, IOException {
		...
		List<org.tum.gis.minisos.observation.Observation> queriedObservations = observationService.getObservationList(timeseriesId);
	...
	public Observations getObservations(String startTime, String endTime) throws ParseException, IOException, URISyntaxException {
		...
		int timeseriesId = timeseriesService.getTimeseriesById(dataSourceService.getAllDataSources().get(0).getId()).getId();
		AtomicInteger observationSeq = new AtomicInteger();
		List<org.tum.gis.minisos.observation.Observation> queriedObservations = observationService.getObservationList(timeseriesId, startTime, endTime);
		switch(timeseriesService.getTimeseriesById(timeseriesId).getObservationType().toUpperCase()){
			case "OM_MEASUREMENT":
				for(int i=0;i<queriedObservations.size();i++) {
					Observation observation = new Observation();
